    ...
    <div class="max-w-sm w-full bg-white p-8 mr-24 rounded-lg shadow-md">
      ...
      <form class="w-full" @submit.prevent="login">
        ...
        <button
          type="submit"
          :disabled="isLoading"
          class=" text-[#0E77FF] cursor-pointer border-2 py-2 px-12 rounded-[30px] hover:bg-blue-700 hover:text-white focus:outline-none flex items-center focus:ring-2 focus:ring-[#0E77FF] disabled:opacity-50 mx-auto"
        >
